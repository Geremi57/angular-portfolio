...
@Component({
  ...
  template: `
    <section id="projects" class="relative py-20 md:py-32 bg-gradient-to-b from-blue-950 via-black to-gray-900 overflow-hidden">
      <!-- Background Elements -->
      <div class="absolute inset-0">
        ...
        <div *ngFor="let snippet of floatingCode"
        ...
        <!-- Glowing orbs -->
        <div class="absolute -top-20 -right-20 w-64 h-64 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse"></div>
        <div class="absolute -bottom-20 -left-20 w-64 h-64 bg-cyan-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse" style="animation-delay: 2s"></div>
      </div>
      ...
      <div class="relative z-10 container mx-auto px-4">
        ...
        <div class="text-center mb-16 md:mb-20" [@fadeInUp]>
          ...
          <h2 class="text-3xl md:text-5xl font-bold mb-6">
            Featured
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300"> Projects</span>
          </h2>
        ...
        <div class="relative max-w-6xl mx-auto">
          ...
          <div class="relative h-[500px] md:h-[600px] overflow-hidden rounded-3xl bg-gradient-to-br from-blue-900/20 via-black/40 to-gray-900/30 border border-blue-800/30 backdrop-blur-sm">
            <div class="absolute inset-0">
              <!-- Active Project Display -->
              <div *ngIf="projects[currentIndex]" 
                   [@slideAnimation]="slideDirection"
                   class="absolute inset-0">
                <div class="h-full grid lg:grid-cols-2 gap-0">
                  <!-- Project Image/Visual -->
                  <div class="relative h-full min-h-[300px] md:min-h-[400px] overflow-hidden bg-gradient-to-br from-blue-900 to-cyan-900">
                    <div class="absolute inset-0 bg-gradient-to-br from-blue-900/50 to-black/50 z-10"></div>
                    <div class="absolute inset-0 flex items-center justify-center p-8">
                      <div class="relative w-full h-full max-w-2xl mx-auto">
                        <!-- Mockup Device Frame -->
                        <div class="absolute inset-0 border-8 border-blue-800/30 rounded-3xl pointer-events-none"></div>
                        <div class="absolute inset-4 border-4 border-blue-600/20 rounded-2xl pointer-events-none"></div>
                        
                        <!-- Project Screenshot Placeholder -->
                        <div class="absolute inset-8 bg-gradient-to-br from-blue-800/30 to-cyan-800/30 rounded-xl overflow-hidden">
                          <!-- Animated code preview -->
                          <div class="absolute inset-0 p-6 font-mono text-sm">
                            <div *ngFor="let line of projects[currentIndex].codePreview; let i = index"
                          ...
                          <div class="absolute bottom-4 right-4 flex space-x-2">
                            <div *ngFor="let tag of projects[currentIndex].tags.slice(0, 3)"
                  ...
                  <!-- Project Details -->
                  <div class="p-8 md:p-12 flex flex-col justify-center bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-sm">
                    <!-- Project Header -->
                    <div class="mb-6">
                      <div class="inline-flex items-center space-x-2 mb-4">
                        <span class="px-3 py-1 bg-blue-900/50 border border-blue-700/30 rounded-full text-sm text-blue-300">
                    ...
                    <div class="mb-8">
                      ...
                      <div class="flex flex-wrap gap-2">
                        <div *ngFor="let tech of projects[currentIndex].technologies"
                    ...
                    <div class="flex flex-wrap gap-4 mt-auto pt-6">
                      <a [href]="projects[currentIndex].liveLink"
                         target="_blank"
                      ...
                      <a [href]="projects[currentIndex].githubLink"
                         target="_blank"
        ...
        <div class="text-center mt-16" [@fadeInUp]="{value: '', params: {delay: '0.3s'}}">
          <div class="inline-flex items-center space-x-4">
            ...
            <button class="px-8 py-4 border-2 border-blue-400/30 rounded-xl font-semibold hover:border-blue-400/50 hover:bg-blue-900/30 transform hover:scale-105 transition-all duration-300 group">
              <span class="text-blue-300 group-hover:text-white">View All Projects</span>
              <svg class="w-5 h-5 inline-block ml-2 group-hover:translate-x-1 transition-transform duration-300" 
                   fill="none" 
                   stroke="currentColor" 
                   viewBox="0 0 24 24">
  ...
  projects = [
    {
      ...
      year: '2023',
      description: 'A comprehensive analytics dashboard built with Angular and D3.js for real-time data visualization and business intelligence.',
    ...
    },
    {
      ...
      year: '2023',
      description: 'Modern e-commerce platform with Angular frontend, Node.js backend, and PostgreSQL database. Features include cart management, payment integration, and admin dashboard.',
    ...
    },
    {
      ...
      year: '2024',
      description: 'Progressive Web Application for tracking workouts, nutrition, and health metrics. Features offline functionality and mobile-optimized interface.',
    ...
    },
    {
      ...
      year: '2024',
      description: 'AI-powered content generation platform integrating OpenAI API with custom Angular interface for creating marketing content, blogs, and social media posts.',
